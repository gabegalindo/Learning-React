...
function CreateCabinForm({ cabinToEdit = {}, onCloseModal }) {
  ...
  function onSubmit(data) {
    ...
    if (isEditSession)
      editCabin(
        { newCabinData: payload, id: editId },
        {
          onSuccess: (data) => {
            onCloseModal?.();
          },
        ...
        <Input
          ...
          {...register("discount", {
            ...
            validate: (value, { regularPrice }) => {
              // Can retrieve other form values using getValues fn or through  object destructuring in this fn's params
              // Note that the values come through as strings
              // console.log(Number(getValues().regularPrice));
              // console.log(Number(value), regularPrice);
              return (
